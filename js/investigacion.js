...
(function initInvestigacion() {
    ...
    roleBanner.innerHTML =
        sesion.rol === 'decanato'
            ...
            : 'Estás viendo el panorama institucional completo de Investigación.';
    function renderVista(vista, contenedor) {
      ...
      `;
        ...
        trackEvento('dashboard_category_viewed', {
            ...
            analysis_context: `investigacion:${vista.id}`,
...
//# sourceMappingURL=investigacion.js.map