(function initHeroPreview(): void {
  ...
  const heroPreview: HTMLElement = preview;
  ...
  function contarValor(el: SVGTextElement): void {
  ...
  function revelar(): void {
    ...
    heroPreview.querySelectorAll<SVGTextElement>('.pv-value[data-count-to]').forEach(contarValor);
  }
