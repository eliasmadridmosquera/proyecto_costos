...
type RolAsignado = 'Webmaster' | 'Administrador' | 'Rectorado' | 'Decanato' | 'Auditor externo';
...
const ROLES_ASIGNABLES: RolAsignado[] = ['Webmaster', 'Administrador', 'Rectorado', 'Decanato', 'Auditor externo'];
...
const USUARIOS_INICIALES: UsuarioSistema[] = [
  ...
  { id: 5, nombre: 'Cielo Andrade', correo: 'visitante@umeridiano.edu.ec', rol: 'Auditor externo', facultad: null, activo: true },
